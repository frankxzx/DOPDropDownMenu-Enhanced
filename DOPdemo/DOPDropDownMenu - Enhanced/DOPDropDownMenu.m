...
- (instancetype)initWithOrigin:(CGPoint)origin width:(CGFloat)width andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        _cellSelectedColor = kCellBgColor;
        _cellUnSelectedColor = [UIColor whiteColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        ...
        cell.backgroundColor = self.cellUnSelectedColor;
        DOPBackgroundCellView *bg = [[DOPBackgroundCellView alloc]init];
        bg.backgroundColor = self.cellSelectedColor;
